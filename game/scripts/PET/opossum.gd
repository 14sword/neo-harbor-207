...
@export var follow_speed: float = 130.0
@export var catch_up_speed: float = 220.0
...
func _log_pet_action(action: String):
	var action_names = {"idle": "发呆", "walk": "散步"}
